...
class CineKids extends StatefulWidget {
  final List<Salle> salles;
  final List<Genre> genres;

  final int dayIndex;

  CineKids({Key key, this.dayIndex, this.salles, this.genres})
      : super(key: key);

  @override
  _CineKidsState createState() => _CineKidsState(salles, genres);
}

class _CineKidsState extends State<CineKids> {
  final List<Salle> salles;
  final List<Genre> genres;

  _CineKidsState(this.salles, this.genres);
  @override
  void initState() {
    super.initState();
